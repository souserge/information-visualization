...
# USER root
# RUN apt-get update -y && apt-get install -y chromium-chromedriver

USER root

ARG firefox_ver=74.0
...
RUN pip install altair vega-datasets jupyter-contrib-nbextensions nbconvert selenium nb-pdf-template altair-saver
